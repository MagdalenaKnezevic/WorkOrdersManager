...
// Dohvati timove u kojima je trenutni korisnik radnik
$query = "SELECT t.id, t.nameOfTeams FROM teams t
          JOIN teamsWorkers tw ON t.id = tw.teamId
          WHERE tw.workerId = ?";
            ...
            <div class="teams-list">
                <?php foreach ($teams as $team): ?>
                    <div class="team">
                        ...
                        <a href="teamDetailsWorker.php?teamId=<?php echo htmlspecialchars($team['id']); ?>">
                            <?php echo htmlspecialchars($team['nameOfTeams']); ?>
                        </a>
                    </div>
                <?php endforeach; ?>
            </div>
        <?php else: ?>
            <p>Currently you are not the member of any team.</p>
        <?php endif; ?>
    </div>
